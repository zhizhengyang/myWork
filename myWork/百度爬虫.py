# -*- coding: utf-8 -*-
"""
Created on Thu Jan 25 22:04:36 2018
...
class Crawler:
    ...
    def __save_image(self, rsp_data, word):
        ...
        if not os.path.exists("/home/mrzack/attention/spawl/"):
            return 0
            #           os.mkdir("C:\\Users\\yzz\\Desktop\\image\\beautiful")
        # 判断名字是否重复，获取图片长度
        self.__counter = len(os.listdir("/home/mrzack/attention/spawl/")) + 1
        for image_info in rsp_data['imgs']:
            try:
                time.sleep(self.time_sleep)
                fix = self.__get_suffix(image_info['objURL'])
                urllib.urlretrieve(image_info['objURL'], '/home/mrzack/attention/spawl/'+ str(self.__counter) + str(fix))
    ...
    # 开始获取
    def __get_images(self, word='Selfie'):
